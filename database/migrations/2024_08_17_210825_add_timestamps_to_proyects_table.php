...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('proyects', function (Blueprint $table) {
            ...
            $table->timestamps();  // Agrega las columnas created_at y updated_at que son las columnas que Laravel agrega automáticamente a las tablas para manejar los timestamps
